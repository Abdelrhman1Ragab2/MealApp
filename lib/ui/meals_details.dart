          ...
          children: [
            ...
            Stack(children: [
              ...
              Container(
                ...
                child: IconButton(icon: const Icon(Icons.star), color:  Provider.of<FavoriteProvider>(context).mealIds.contains(meal.id)?Colors.yellow:Colors.white,
                onPressed: (){
                  Provider.of<FavoriteProvider>(context,listen: false).onSelectFavorite(meal);
                }
                  ...
                  itemBuilder: (context, index) => Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              meal.steps[
                                  index], // overflow: TextOverflow.ellipsis,
                              style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.w400,
                                color: Colors.white,
